import sys
sys.path.insert(0,"../../../../tools/source_code/aurora/")
from retrieval import Retrieval
from instrument import Instrument
from atm_profile import Profile
from absorption import Absorption
from RT import RT
from pvalues import p_value
...
if run_params.simulate_data:
    ...
    add_error=False #displace points by median
...
if run_params.AmIMaster():
    ...
    if run_params.pvalue:
        pval.p_value(run_params.output_ret, ret.n_params)
