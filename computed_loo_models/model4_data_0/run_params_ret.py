...
pecul_name1 = "xclouds"                                                                       # pecul_name_1 = label for the retrieval
num_live_pts = 1000
...
leave_out_file_generator=True                                                               #Are you generating the LOO files?
leave_out_file_plot=True                                                                    #Are you plotting the LOO analyser?
...
true_values=[-3.3,-6.0,-7.0,1500.0,1.0]                                                                            #Do you have true values for the data you are retrieving? for instance something like [-5.0,-12.0,-12.0,-12.0,-12.0,-12.0,-12.0,1500,1.0,1.0,-2.0,-4.0,0.0,-0.3,0.0,-4.0,0.0,0.0]
...
cloudy_atm = False                                                                          #Do you want a cloudy atmosphere?
